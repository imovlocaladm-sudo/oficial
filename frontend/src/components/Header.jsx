        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <Link to="/planos" className="text-blue-600 hover:text-blue-700 transition-colors font-semibold">Planos</Link>
          ...
          {mobileMenuOpen && (
            <nav className="lg:hidden py-4 border-t">
              <div className="flex flex-col gap-3">
                ...
                <Link to="/planos" className="text-blue-600 hover:text-blue-700 transition-colors py-2 font-semibold">Planos</Link>
